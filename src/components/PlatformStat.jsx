  ...
  return (
    <WidgetWrapper>
      ...
      {platformData.map((platform) => (
        <div key={platform.id}>
          <h3 className="font-jakarta text-[14px] md:text-[18px] text-[#22242C] dark:text-white mt-2">
            {platform.name}
          </h3>
          <ProgressBar
          ...
          />
          <div className="flex items-center justify-between">
            <span className="text-[#525252] dark:text-white font-jakarta text-[14px] md:text-[18px]">
              {platform.amount}
            </span>
            <span className="text-[#525252] dark:text-white font-jakarta text-[14px] md:text-[18px]">
